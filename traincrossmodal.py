...
from modules.model_architecture.couple_crossmodalattention_bert_crf import CoupleCrossModalRobertaTokenClassificationCRF
...
if args.mm_model == 'MTCCMBert':
    model = CoupleCrossModalRobertaTokenClassificationCRF.from_pretrained(args.bert_model,
...
# loadmodel
if args.mm_model == 'MTCCMBert':
    model = CoupleCrossModalRobertaTokenClassificationCRF.from_pretrained(args.bert_model, layer_num1=args.layer_num1, layer_num2=args.layer_num2,
