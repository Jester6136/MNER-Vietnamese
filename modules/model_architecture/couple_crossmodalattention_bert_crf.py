...
class CoupleCrossModalRobertaTokenClassificationCRF(RobertaPreTrainedModel):
    ...
    def __init__(self, config, layer_num1=1, layer_num2=1, layer_num3=1,  num_labels_=2, auxnum_labels=2):
        super(CoupleCrossModalRobertaTokenClassificationCRF, self).__init__(config)
...
if __name__ == "__main__":
    model = CoupleCrossModalRobertaTokenClassificationCRF.from_pretrained('vinai/phobert-base-v2')
    print(model)