...
class MNERProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ["O",'B-GENDER', 'I-GENDER','B-TRANSPORTATION', 'I-TRANSPORTATION','B-JOB', 'I-JOB','B-SYMPTOM_AND_DISEASE', 'I-SYMPTOM_AND_DISEASE','B-NAME', 'I-NAME', 'B-ORGANIZATION', 'I-ORGANIZATION', 'B-AGE', 'I-AGE', 'B-LOCATION', 'I-LOCATION', 'B-DATE', 'I-DATE', 'B-PATIENT_ID', 'I-PATIENT_ID', "X", "[CLS]", "[SEP]"]
