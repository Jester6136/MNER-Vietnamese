...
if args.server_ip and args.server_port:
    ...
    if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        acc, f1, p, r = evaluate(y_pred_idx, y_true_idx, sentence_list, reverse_label_map)
        print("Overall: ", p, r, f1)
        gender_f1, gender_p, gender_r = evaluate_each_class(y_pred_idx, y_true_idx, sentence_list, reverse_label_map, 'GENDER')
        print("Gender: ", gender_p, gender_r, gender_f1)
        transportation_f1, transportation_p, transportation_r = evaluate_each_class(y_pred_idx, y_true_idx, sentence_list, reverse_label_map, 'TRANSPORTATION')
        print("Transportation: ", transportation_p, transportation_r, transportation_f1)
        job_f1, job_p, job_r = evaluate_each_class(y_pred_idx, y_true_idx, sentence_list, reverse_label_map, 'JOB')
        print("Job: ", job_p, job_r, job_f1)

        symptom_f1, symptom_p, symptom_r = evaluate_each_class(y_pred_idx, y_true_idx, sentence_list, reverse_label_map, 'SYMPTOM_AND_DISEASE')
        print("Symptom and Disease: ", symptom_p, symptom_r, symptom_f1)

        name_f1, name_p, name_r = evaluate_each_class(y_pred_idx, y_true_idx, sentence_list, reverse_label_map, 'NAME')
        print("Name: ", name_p, name_r, name_f1)

        organization_f1, organization_p, organization_r = evaluate_each_class(y_pred_idx, y_true_idx, sentence_list, reverse_label_map, 'ORGANIZATION')
        print("Organization: ", organization_p, organization_r, organization_f1)

        age_f1, age_p, age_r = evaluate_each_class(y_pred_idx, y_true_idx, sentence_list, reverse_label_map, 'AGE')
        print("Age: ", age_p, age_r, age_f1)

        location_f1, location_p, location_r = evaluate_each_class(y_pred_idx, y_true_idx, sentence_list, reverse_label_map, 'LOCATION')
        print("Location: ", location_p, location_r, location_f1)

        date_f1, date_p, date_r = evaluate_each_class(y_pred_idx, y_true_idx, sentence_list, reverse_label_map, 'DATE')
        print("Date: ", date_p, date_r, date_f1)

        patient_id_f1, patient_id_p, patient_id_r = evaluate_each_class(y_pred_idx, y_true_idx, sentence_list, reverse_label_map, 'PATIENT_ID')
        print("Patient ID: ", patient_id_p, patient_id_r, patient_id_f1)
        ...
        with open(output_eval_file, "w") as writer:
            ...
            writer.write("Gender: " + str(gender_p) + ' ' + str(gender_r) + ' ' + str(gender_f1) + '\n')
            writer.write("Transportation: " + str(transportation_p) + ' ' + str(transportation_r) + ' ' + str(transportation_f1) + '\n')
            writer.write("Job: " + str(job_p) + ' ' + str(job_r) + ' ' + str(job_f1) + '\n')
            writer.write("Symptom and Disease: " + str(symptom_p) + ' ' + str(symptom_r) + ' ' + str(symptom_f1) + '\n')
            writer.write("Name: " + str(name_p) + ' ' + str(name_r) + ' ' + str(name_f1) + '\n')
            writer.write("Organization: " + str(organization_p) + ' ' + str(organization_r) + ' ' + str(organization_f1) + '\n')
            writer.write("Age: " + str(age_p) + ' ' + str(age_r) + ' ' + str(age_f1) + '\n')
            writer.write("Location: " + str(location_p) + ' ' + str(location_r) + ' ' + str(location_f1) + '\n')
            writer.write("Date: " + str(date_p) + ' ' + str(date_r) + ' ' + str(date_f1) + '\n')
            writer.write("Patient ID: " + str(patient_id_p) + ' ' + str(patient_id_r) + ' ' + str(patient_id_f1) + '\n')
